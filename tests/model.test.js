...
// The GitHub token must never be sent to Codeberg.
for (const t of M.fetchTasks("codeberg.org/scid/scid", 50, "gho_secret"))
  assert.ok(t.argv.join(" ").indexOf("Authorization") === -1, "token leaked to Codeberg")
